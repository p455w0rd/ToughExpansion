...
public class ModGlobals {
	...
	public static final String VERSION = "3.4.24";
	...
	public static final String DEPENDANCIES = "required-after:" + MODID_TAN + ";required-after:" + MODID_PWLIB + "@[2.0.23,);after:" + MODID_BAUBLES;
